                ...
                <div className="app_sidebar">
                    <div className="app_sidebar_wrap">
                        <div className="app_sidebar_wrapper" id="sidebar">
                            <div>
                                <Link href={"/create-blog"} className="create_button_wrapper" aria-expanded="false">
                            ...
                            <ul className="sidebar_list">
                                <li>
                                    <Link aria-current="page" className={pathname === "/dashboard" ? "sidebar_item  onselect" : "sidebar_item"} href="/dashboard">
                                ...
                                <li>
                                    <Link className={pathname === "/dashboard/course" ? "sidebar_item  onselect" : "sidebar_item"} href="/dashboard/course">
                                ...
                                <li>
                                    <Link className={pathname === "/dashboard/blog" ? "sidebar_item  onselect" : "sidebar_item"} href="/dashboard/blog">
